...
- MEMORY.md index with 500-line / 50KB limits
...
"""
    ...
    def _update_index(self):
        ...
        Ch6: index entries are one line each, max 250 chars.
        """
        self.ensure_dir()
        entries = []
        ...
        # Second: byte limit (50KB) — truncate at character boundary to avoid

...
_logger = logging.getLogger("nexgent.hooks")
...
class HookEvent(Enum):
    """Lifecycle events (Ch8: 18 events, we implement the core ones)."""
    ...
    def _run_command_hook(
        ...
        try:
            ...
            if result.returncode != 0 and result.returncode != 2:
                ...
                _logger.warning("Command hook exited with code %d (expected 0 or 2), treating as approve", result.returncode)
                return HookResult()

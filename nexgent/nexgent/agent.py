...
# ---------------------------------------------------------------------------
# Enums for loop termination reasons (Ch2: seven termination reasons)
# ---------------------------------------------------------------------------
...
class NexgentAgent:
    ...
    SYSTEM_PROMPT_TEMPLATE = """You are Nexgent, a capable AI assistant.
...
- Some Unix commands are auto-translated, but prefer native Windows commands"""
    ...
    def run(self, task: str, session: Session = None) -> str:
        ...
        Termination reasons (Ch2: seven reasons):

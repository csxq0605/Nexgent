...
| --- | --- | --- | --- |
| A 内核选型 | [同题小样](../../experiments/kernel_spike/CONTRACT.md)；[DeepSeek 架构](https://github.com/deepseek-ai/deepseek-harness/blob/46a7f68b0922371ce7144b668b90e377d8e799f4/docs/architecture.md)服务／provider／工具分离 | [固定源码对照](kernel-reference-audit-20260923.md)与[Python 小样负结果](../../experiments/kernel_spike/RESULTS.md)；后者以固定模型接口跑通预先授权的任务，任务内装入被不可变 Episode 拒绝 | A1 已完成，A2 实现中；实跑 DeepSeek 路径，补两条路的生命周期／恢复比较，再提交 ADR |
